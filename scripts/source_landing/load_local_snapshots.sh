...
landing_root="${SOURCE_LANDING_ROOT:-dbfs:/Volumes/workspace/source_landing/source_snapshot_files/banking_v2}"
...
for domain in "${domains[@]}"; do
  for business_date in "${dates[@]}"; do
    ...
    target_path="${landing_root}/simulation_id=${simulation_id}/snapshot_type=full/business_date=${business_date}/${domain}"
