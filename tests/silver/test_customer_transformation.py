...
def test_build_party(test_spark):
    ...
    df_core = test_spark.createDataFrame([("CB-101", "SIM_01", "2026-07-01", "RUN_01")], schema_core)
    ...
    df_crm = test_spark.createDataFrame([("CRM-202", "SIM_01", "2026-07-01", "RUN_01")], schema_crm)
