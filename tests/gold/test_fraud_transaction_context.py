...
def test_ai_fraud_transaction_context_core_scenarios(test_spark):
    ...
    assert (
        float(fe1.latest_risk_score) == 0.85
    )  # latest scored_date wins over the older 0.10
...
def test_merchant_max_store_risk_ordering(test_spark):
    ...
    df_ap = test_spark.createDataFrame(
        [
            (
                ...
                None,
                "MA",
            ),  # merchant with LOW + HIGH stores -> HIGH ceiling
            (
                "FEB",
                20000.0,
                "PURCHASE",
                ...
                None,
                "MB",
            ),  # merchant with only LOW stores -> LOW ceiling
        ],
        schema_ap,
    )
    ...
    empty_cp = test_spark.createDataFrame(
        [],
        StructType(
            [
                StructField("financial_event_key", StringType(), True),
    ...
    empty_atm = test_spark.createDataFrame(
        [],
        StructType(
            [
                StructField("financial_event_key", StringType(), True),
    ...
    empty_gp = test_spark.createDataFrame(
        [],
        StructType(
            [
                StructField("financial_event_key", StringType(), True),
    ...
    empty_tc = test_spark.createDataFrame(
        [],
        StructType(
            [
                StructField("channel_key", StringType(), True),
    ...
    empty_fers = test_spark.createDataFrame(
        [],
        StructType(
            [
                StructField("financial_event_key", StringType(), True),
    ...
    empty_fefa = test_spark.createDataFrame(
        [],
        StructType(
            [
                StructField("financial_event_key", StringType(), True),
    ...
    empty_fa = test_spark.createDataFrame(
        [],
        StructType(
            [
                StructField("fraud_alert_key", StringType(), True),
    ...
    empty_cfa = test_spark.createDataFrame(
        [],
        StructType(
            [
                StructField("financial_event_key", StringType(), True),
