...
def test_ai_aml_investigation_context_aggregations_and_dq_status(test_spark):
    ...
    df_ic = test_spark.createDataFrame([
        ("IC_001", "AML", "ALERT", "CLOSED", "HIGH", "2026-07-01 09:00:00", "2026-07-05 10:00:00", "ANALYST_01", "fincrime", "CASE_001", "2026-07-05 10:00:00", "RUN_01"),
        ("IC_002", "FRAUD", "REFERRAL", "OPEN", "MEDIUM", "2026-07-02 09:00:00", None, "ANALYST_02", "fincrime", "CASE_002", "2026-07-02 09:00:00", "RUN_01")
    ], schema_ic)
    ...
    df_sar = test_spark.createDataFrame([
        ("SAR_01", "AML_NEW", "2026-07-04", None, "FILED")
    ], schema_sar)
    ...
    df_icss = test_spark.createDataFrame([
        ("IC_001", "SCR_100")
    ], schema_icss)
    ...
    df_ss = test_spark.createDataFrame([
        ("SCR_100", "WL_500", "POTENTIAL_MATCH", 92.5)
    ], schema_ss)
    ...
    df_we = test_spark.createDataFrame([
        ("WL_500", "SANCTIONS")
    ], schema_we)
    ...
    df_icfa = test_spark.createDataFrame([("IC_001", "FA_01"), ("IC_001", "FA_02")], schema_icfa)
